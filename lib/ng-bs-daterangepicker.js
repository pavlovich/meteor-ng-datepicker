...
ngMeteor.directive('input', function ($compile, $parse) {
	return {
		restrict: 'E',
		require: '?ngModel',
		link: function ($scope, $element, $attributes, ngModel) {
			if ($attributes.type !== 'daterange' && ($attributes.type !== 'datesingle') || ngModel === null ) return;

			var options = {};
			options.format = 'YYYY-MM-DD HH:mm';  // $attributes.format || 'YYYY-MM-DD';
            ...
            options.singleDatePicker = ($attributes.type == 'datesingle');
